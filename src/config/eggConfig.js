/** Sprites e layout — tela do ovo (chocar) — export Figma 3x, sprites/ui/ */
...
/** ovo_mexendo.png — 3489×603, 7 frames colados (498×603) */
export const EGG_WOBBLE_FRAME_COUNT = 7;
export const EGG_WOBBLE_FRAME_W = 498;
export const EGG_WOBBLE_FRAME_H = 603;

/** ovo_quebrando.png — 2151×603, 3 frames (717×603) */
export const EGG_CRACK_FRAME_COUNT = 3;
export const EGG_CRACK_FRAME_W = 717;
export const EGG_CRACK_FRAME_H = 603;

/** ovo_aberto.png — 2154×603, 3 frames (718×603) */
...
export const EGG_LEAVES_Y_RATIO = 0.90;
